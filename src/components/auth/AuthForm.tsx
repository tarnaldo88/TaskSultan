...
function AuthForm() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-900 via-gray-950 to-gray-900">
      {tab === 'login' && (
        <button
          type="button"
          className="absolute top-8 right-8 z-10 px-6 py-2 rounded-xl bg-gradient-to-r from-purple-600 via-blue-600 to-purple-700 hover:from-purple-700 hover:via-blue-700 hover:to-purple-800 text-white font-semibold shadow-lg shadow-purple-900/30 transition-all duration-200 border-0 focus:ring-2 focus:ring-purple-500 focus:outline-none"
          onClick={() => setTab('register')}
        >
          Register
        </button>
      )}
      <Card className="w-full max-w-md shadow-2xl rounded-xl border-0 bg-gray-900/90 backdrop-blur-md">
        <CardHeader>
          <CardTitle className="flex items-center justify-center gap-4 text-center text-4xl font-extrabold tracking-tight text-white">
            <img
              ...
              draggable="false"
            />
            <span className="inline-block align-middle">TaskSultan</span>
          </CardTitle>
        </CardHeader>
        <CardContent>
